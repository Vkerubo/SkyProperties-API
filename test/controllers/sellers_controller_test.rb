...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference("Seller.count") do
      post sellers_url, params: { seller: { email: @seller.email, name: @seller.name, phone: @seller.phone } }, as: :json
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { email: @seller.email, name: @seller.name, phone: @seller.phone } }, as: :json
    assert_response :success
  end
